...
- Re-create the CLDF dataset:
  ```shell
  cldfbench makecldf --glottolog-version v5.2 cldfbench_gray_et_al2009.py --with-zenodo --with-cldfreadme
  ```
...
- Re-create the README:
  ```shell
  cldfbench readme cldfbench_gray_et_al2009.py
  ```
- Run Phlorest-specific checks on the data:
  ```shell
  phlorest check --with-R cldfbench_gray_et_al2009.py
  ```
...
- Create the release instruction:
  ```shell
  phlorest release cldfbench_gray_et_al2009.py vX.Y
  ```
